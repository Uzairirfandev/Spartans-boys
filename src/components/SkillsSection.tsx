      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="inline-block bg-[#BB0903] text-white px-3 md:px-4 py-0.5 -rotate-3 border-[3px] border-gray-700 shadow-[4px_4px_0_rgba(0,0,0,0.45)]">Statistics</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
