        ...
        <div className="relative z-10 container mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-poppins font-extrabold uppercase tracking-tight text-white mt-2 mb-4">
              ...
              <span className="inline-block bg-[#BB0903] text-black px-3 md:px-4 py-0.5 -rotate-3 border-[3px] border-gray-700 shadow-[4px_4px_0_rgba(0,0,0,0.45)]">Gallery</span>
            </h2>
